...
?>
    ...
    <head>
        ...
        <title>View Department | CSSX</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-center">
                            <h1 class="h3 mb-4 text-gray-800 text-center"><strong> Departments </strong></h1>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="card mb-5 border-bottom-primary">
                                            <div class="card-header text-center bg-primary bg-gradient text-white">
                                                <h5><strong> <?php echo $dept['name'] ?> </strong></h5>
                                            </div>
                                            <div class="card-body">
                                                <ul class="list-group list-group-flush">
                                                    <?php
                                                    $jobs = $jobContr->selectJobByDept($dept['dept_id']);
                                                    foreach ($jobs as $job) { ?>
                                                        <li class="list-group-item " data-toggle="tooltip" data-placement="top" title="Monthly Basic Salary: $<?php echo $job['basic_salary'] ?>"> <?php echo $job['title'] ?></li>
                                                    <?php } ?>
                                                </ul>
