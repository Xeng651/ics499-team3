                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <nav class="navbar mb-3 justify-content-center bg-gradient bg-primary text-white rounded">
                                <ul class="list-group list-group-horizontal">
                                    <li class="list-group-item"><a href="https://www.reuters.com/" target="_blank" rel="noopener noreferrer">World News</a></li>
                                    <li class="list-group-item"><a href="https://www.kare11.com/" target="_blank" rel="noopener noreferrer">Local News</a></li>
                                </ul>
                            </nav>
                         
                            <div class="col-lg-6 col-md-10 col-sm-10">
                                <a class="twitter-timeline" data-theme="dark" href="https://twitter.com/CssxInc">Tweets by CSSX</a>
