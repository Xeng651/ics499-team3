                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                ?>
                                                <br>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pfp">Change Profile Photo</button>
                                            </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="profile.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input type="submit" name="submitPhoto" class="btn btn-primary" value="Update" />
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="profile.php" method="POST">
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <div class="form-row">
                                                                <div class="col">
                                                                    ...
                                                                    <input type="text" id="fname" name="fname" class="form-control" value="<?php echo $user[0]['first_name'] ?>">
                                                                </div>
                                                                <div class="col">
                                                                    <label for="lname">Last Name:</label>
                                                                    <input type="text" id="lname" name="lname" class="form-control" value="<?php echo $user[0]['last_name'] ?>">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="gender" id="Radios1" value="Male" <?php echo ($user[0]['gender'] == 'Male' ? ' checked=checked' : ''); ?>>
                                                                <label class="form-check-label" for="Radios1">
                                                                    Male
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="gender" id="Radios2" value="Female" <?php echo ($user[0]['gender'] == 'Female' ? ' checked=checked' : ''); ?>>
                                                                <label class="form-check-label" for="Radios2">
                                                                    Female
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="gender" id="Radios3" value="Others" <?php echo ($user[0]['gender'] == 'Others' ? ' checked=checked' : ''); ?>>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="birthday" name="birthday" class="form-control" value="<?php echo $user[0]['birth_date'] ?>">
                                                        </div>
                                                        <?php
                                                        if ($_SESSION['role'] == 'Employee') {
                                                        ?>
                                                    ...
                                                    <div class=" modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                        <input type="submit" name="submitProfile" class="btn btn-primary" value="Update" />
                                                    </div>
                                                </form>
