...
if ($_SESSION['valid_user']) {
    ...
    $dept = $deptContr->selectDepartment($employee[0]['employee_id']);
                                    ...
                                    <div class="card-body">
                                        <form action="edit-emp.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" id="dept" name="deptName" class="form-control" value="<?php echo $dept[0]['name'] ?>">
                                                    </div>
                                                    <div class="col">
                                                        <label for="job">Job:</label>
                                                        <input type="text" id="job" name="jobTitle" class="form-control" value="<?php echo $job[0]['title'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="phone" name="phone" class="form-control" value="<?php echo $employee[0]['phone'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="datejoined">Date Joined:</label>
                                                <input type="date" id="datejoined" name="datejoined" class="form-control" value="<?php echo $employee[0]['date_joined'] ?>">
                                            </div>
                                            <a href="manage-emp.php" class="btn btn-secondary btn-xs">Cancel</a>
                                            <input type="hidden" name="empID" value="<?php echo $empID ?>"/>
                                            <input type="submit" name="editEmp" class="btn btn-primary" value="Update" />
                                        </form>
                                    </div>
                                </div>
                            </div>
