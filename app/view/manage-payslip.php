                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    $salary = $SalaryContr->selectAllSalaries();
                                                    ...
                                                    ?>
                                                        <tbody>
                                                            <tr>
                                                                <th><?php echo $salary['employee_id']; ?></th>
                                                                <td><?php echo $salary['gross_pay']; ?></td>
                                                                <td><?php echo $salary['allowance'] . " " . $salary['deduction']; ?></td>
                                                                <td><?php echo $dept[0]['name']; ?></td>
                                                                <td><?php echo $salary['bank_name']; ?></td>
                                                                <td><?php echo $salary['net_pay']; ?></td>
                                                                <td><?php echo date('M j, Y', strtotime($salary['date'])) ?></td>
