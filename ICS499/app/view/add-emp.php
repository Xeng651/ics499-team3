                        ...
                        <div id="collapseEmp" class="collapse show" aria-labelledby="headingEmp" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                ?>
                                    ...
                                    <a class="collapse-item active" href="add-emp.php">Add Employee</a>
                                <?php } else { ?>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapsePayroll" class="collapse" aria-labelledby="headingPayroll" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <?php } else { ?>
                                    <a class="collapse-item" href="manage-payslip.php">View My Payslips</a>
                                <?php } ?>
                            </div>
                        </div>
                    </li>
                                            ...
                                            <form action="add-emp.php" method="POST">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <select id="job" name="jobTitle" class="form-select">
                                                                    <option disabled="disabled" selected> Select Job Title </option>
                                                                    <?php
                                                                    $jobs = $jobContr->selectAllJobs();
                                                                    foreach ($jobs as $j) {
                                                                    ?>
                                                                        <option> <?php echo $j['title']; ?> </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control col-md-5 col-sm-5" placeholder="000-000-0000">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="datejoined">Date Joined:</label>
                                                    <input type="date" id="datejoined" name="datejoined" class="form-control col-md-5 col-sm-5">
                                                </div>
                                                <a href="manage-emp.php" class="btn btn-secondary btn-xs text-capitalize">Cancel</a>
                                                <input type="submit" name="addEmp" class="btn btn-primary text-capitalize" value="Add" />
                                            </form>
                                        </div>
                                    </div>
                                </div>
