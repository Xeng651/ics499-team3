...
?>
    ...
    <head>
        ...
        <title>Manage Employee | CSSX</title>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseEmp" class="collapse show" aria-labelledby="headingEmp" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <?php
                            if ($_SESSION['role'] == "Admin") {
                            ?>
                                <a class="collapse-item active" href="manage-emp.php">Manage Employees</a>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <?php if ($_SESSION['role'] == "Admin") { ?>
                                    <h1 class="h3 mb-4 text-gray-800 text-center"><strong> Manage Employee </strong></h1>
                                <?php } else { ?>
                                    <h1 class="h3 mb-4 text-gray-800 text-center"><strong> All Employees </strong></h1>
                                <?php } ?>
                                ...
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <?php if ($_SESSION['role'] == "Admin") { ?>
                                                <a href="add-emp.php" class="btn btn-primary btn-xs text-capitalize"><i class="fa-solid fa-user-plus"></i></a>
                                            <?php } ?>

                                            <form class="float-right mb-3" action="manage-emp.php" method="POST">
                                                <div class="input-group justify-content-center">
                                                    <div class="form-outline">
                                                        <input type="search" id="search" class="form-control" name="search" data-toggle="tooltip" data-placement="top" title="Search By Employee ID / Employee's Name / Department" required />
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    if (isset($_POST["submitSearch"])) {
                                                        ...
                                                        $search = "%{$_POST['search']}%";
                                                        $employees = $searchContr->searchForEmployee($search);
                                                    } else {
                                                    ...
                                                    ?>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="user-profile.php?empID=<?php echo $employee['employee_id']; ?>"> <?php echo $employee['first_name'] . " " . $employee['last_name']; ?> </a></td>
                                                                    ...
                                                                    ?>
                                                                        <td style="white-space: nowrap">
                                                                            <a href="edit-emp.php?empID=<?php echo $employee['employee_id']; ?>" class="btn btn-primary btn-xs text-capitalize"><i class="fa-solid fa-pencil"></i></a>
                                                                            <a class="btn btn-primary btn-xs text-capitalize" data-toggle="modal" data-target="#delEmp<?php echo $employee['employee_id']; ?>"><i class="fa-solid fa-trash-can"></i></a>
                                                                        </td>
                                                                    <?php } ?>
                                                                </tr>
                                                            </tbody>

                                                            <div class="modal fade" id="delEmp<?php echo $employee['employee_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="delEmp<?php echo $employee['employee_id']; ?>" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="delEmp<?php echo $employee['employee_id']; ?>"><strong> Delete Selected Employee </strong></h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body text-center">
                                                                            <p> <strong> Are you sure you want to delete this employee permanently? </strong></p>
                                                                            <?php echo "Employee ID: " . "<strong>" . $employee['employee_id'] . "</strong>"; ?> <br>
                                                                            <?php echo "Full Name: " . "<strong>" . $employee['first_name'] . " " . $employee['last_name'] . "</strong>"; ?>
                                                                        </div>
                                                                        <form action="manage-emp.php" method="POST">
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button onclick="this.form.submit()" name="deleteEmp" class="btn btn-primary text-capitalize"> Confirm Delete </button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <?php } else { ?>
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="7" class="text-center"><strong>No Employee(s) Found!<strong></td>
                                                            </tr>
                                                        </tbody>
                                                    <?php } ?>
                                                </table>
